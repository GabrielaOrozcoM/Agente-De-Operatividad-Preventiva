...
* **CSS3**: 
    * Flexbox y Grid para el layout responsivo.
    * Animaciones @keyframes para el progreso del círculo y rotación de texto.
    * Efectos de desenfoque (*backdrop-filter*) tipo iOS/iPhone.
* **SVG**: Gráficos vectoriales para el indicador de disponibilidad.
** Y un poquito de JV pero solo para el funcionamiento de un reloj
## 📸 Captura de Pantalla


<img width="1869" height="948" alt="image" src="https://github.com/user-attachments/assets/ad0eb6dd-3fdf-45dc-ac01-0dc440645a18" />
